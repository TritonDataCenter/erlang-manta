...
encode(DSAPrivateKey=#'DSAPrivateKey'{}, Password) ->
	PemEntry = public_key:pem_entry_encode('DSAPrivateKey', DSAPrivateKey, {{"DES-EDE3-CBC", crypto:rand_bytes(8)}, Password}),
	public_key:pem_encode([PemEntry]);
encode(ECPrivateKey=#'ECPrivateKey'{}, Password) ->
	PemEntry = public_key:pem_entry_encode('ECPrivateKey', ECPrivateKey, {{"DES-EDE3-CBC", crypto:rand_bytes(8)}, Password}),
	public_key:pem_encode([PemEntry]);
encode(RSAPrivateKey=#'RSAPrivateKey'{}, Password) ->
	PemEntry = public_key:pem_entry_encode('RSAPrivateKey', RSAPrivateKey, {{"DES-EDE3-CBC", crypto:rand_bytes(8)}, Password}),
	public_key:pem_encode([PemEntry]).
